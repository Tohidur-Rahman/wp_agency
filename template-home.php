                        ...
                        <div class="slide-table">
                           <div class="slide-tablecell">
                              ...
                              <?php 
                                 if($btn_text){
                              ?>
                                <a href="<?php echo esc_attr($btn_url); ?>" class="box-btn"><?php echo $btn_text; ?><i class="fa fa-angle-double-right"></i></a>
         ...
         <div class="container">
            <div class="row section-title">
               <div class="col-md-6 text-right">
                  ...
                  ?>
                  <h3><span><?php echo $about_title['about_sub_heading']; ?></span> <?php echo $about_title['about_heading']; ?></h3>
               </div>
               <div class="col-md-6">
                  <p><?php echo $about_title['about_description']; ?> </p>
               </div>
            </div>
            <div class="row">
               <div class="col-md-7">
                  <div class="about">
                     ...
                     <a href="<?php echo esc_url( $about_content['button_url']); ?>" class="box-btn"><?php echo $about_content['button_text']; ?> <i class="fa fa-angle-double-right"></i></a>
                  </div>
               </div>
               <div class="col-md-5">
                  <?php
               ...
               <div class="col-md-6">
                  <div class="faq">
                     ...
                     <div class="accordion" id="accordionExample">
                        <?php
                           if( class_exists('ACF')){  
                              $faqs = get_field('faq_field', 'option');
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                  <div class="single-counter">
                     <h4><i class="<?php the_field('counter_icon');?>"></i><span class="counter"><?php the_title(); ?></span><?php the_field('description'); ?></span></h4>
                  </div>
               </div>
               <?php     
               };
                     ...
                     <div class="team-hover">
                        <div class="team-content">
                           ...
                           <ul>
                              ...
                              <li><a href="<?php the_field('google_plus_url');?>"><i class="fa fa-google-plus"></i></a></li>
                              <?php } ?>
                           </ul>
                        </div>
                     </div>
               ...
               <div class="col-md-12">
                  <div class="testimonials owl-carousel">
                     ...
                     <div class="single-testimonial">
                        ...
                        <p>" <?php the_field('testimonial_des'); ?> "</p>
